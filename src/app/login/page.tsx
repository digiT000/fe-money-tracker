        ...
        <div className={'grid grid-cols-1  lg:grid-cols-2 gap-10'}>
          ...
          >
            <div className={'flex flex-col gap-4 w-full'}>
              <h1 className={'title font-nunito'}>
                Start every day with{' '}
                <span className={'text-primary-500'}>clarity.</span>
              </h1>
              <p className={'body-text'}>
                {`Whether it's rent, dinner dates, or weekend getaways— log in and
              stay in sync.`}
              </p>
            </div>
            <button
            ...
            <p className={'text-left text-neutral-900'}>
              ...
              <Link className={'underline text-primary-500'} href={'/register'}>
                Register Here
              </Link>
            </p>
          </div>
